  ...
  return (
    <div className="mb-10 text-center w-full">
      ...
      <p className="text-xl text-white lg:w-1/2 sm:w-2/2 mx-auto font-poppins">
        ...
        getting started straightforward. In just a few seconds, you&apos;ll
        receive a tailored plan to achieve your fitness goals, along with a
        personal coach for further guidance.
      </p>
    </div>
  );
}
